...
type StatItem = { label: string; sub: string; count: number; format?: 'millions'; suffix?: string; float?: boolean }
...
const HERO_STATS: StatItem[] = [
  { label: 'Vues TikTok', sub: 'Cumulées - avril 2026', count: 5124294, format: 'millions' },
  { label: 'Abonné·es', sub: 'TikTok', count: 47590 },
  { label: 'Engagement rate', sub: 'Benchmark : 5 - 7 %', count: 21.7, suffix: '%', float: true },
  { label: 'Donateurs·trices', sub: 'Récurrents sans défiscalisation', count: 91 },
]

const MOSAIC_STATS: StatItem[] = [
  { label: 'Likes totaux', sub: "Signal d'adhésion", count: 944052 },
  { label: 'Partages', sub: 'Signal de viralité', count: 75938 },
  { label: 'Commentaires', sub: 'Conversation active', count: 37843 },
  { label: 'Viewers uniques', sub: 'Sur 12 mois', count: 3893265, format: 'millions' },
  { label: 'Vidéos publiées', sub: '14 mois', count: 203 },
  { label: 'Audience France', sub: 'Basée en France', count: 77.4, suffix: '%', float: true },
  { label: 'Audience 18 - 34', sub: 'Tranche centrale', count: 80.7, suffix: '%', float: true },
  { label: 'Dons mensuels', sub: 'HelloAsso', count: 592, suffix: 'EUR' },
]
...
const FORMAT_ITEMS: FormatItem[] = [
  { idx: '01', name: 'FOKUS', tagline: 'Trois voix - 145 à 156 secondes - studio', body: "Format de co-production le plus directement compatible avec des collaborations éditoriales et des enquêtes adaptées aux plateformes courtes.", stat: 'ER moyen : 23 %' },
  { idx: '02', name: 'FOKUS-TEMOIGNAGE', tagline: 'Une voix minoritaire - expérience - cadre politique', body: "Moyenne des 4 meilleurs épisodes : 325 000 vues et 4 744 partages. C'est le format le plus puissant du catalogue.", stat: 'Moyenne des 4 meilleurs : 325k vues' },
  { idx: '03', name: 'OEILDE', tagline: 'Format solo - point de vue personnel', body: 'Moyenne : 20 926 vues, ER 22,6 %. Il performe surtout sur les histoires identitaires et personnelles.', stat: 'Moyenne : 20 926 vues - ER 22,6 %' },
  { idx: '04', name: 'INTERVIEWS LONGUES', tagline: 'Format long - invité·e - YouTube', body: "Entretiens approfondis avec des élu·es, journalistes et représentant·es associatifs. Format de développement de l'audience YouTube et de crédibilité éditoriale à long terme.", stat: 'Format en développement', muted: true },
  { idx: '05', name: 'HEDITO', tagline: 'Format solo du fondateur - fidélisation - conversion', body: "Format face caméra d'Hedi. Son rôle central est la relation parasociale et la conversion en donateurs et donatrices récurrent·es.", stat: 'ER : 23,1 %' },
  { idx: '06', name: 'TRIBUNAL DES MÉDIAS', tagline: 'Format trimestriel - procès fictif - segment libre', body: 'Format déjà documenté et prêt à tourner. Il est bloqué par le temps bénévole disponible, pas par un manque de conception.', stat: 'Prêt à produire', muted: true },
]
