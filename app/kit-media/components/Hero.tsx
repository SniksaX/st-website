  ...
  return (
    <section className="relative border-b border-border overflow-hidden">
      ...
      <Section className="py-16 text-center">
        <p className="text-xs uppercase tracking-[0.22em] text-muted-foreground">Kit média officiel</p>
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          ...
          <a
            ...
            className="rounded-2xl border border-border bg-card text-foreground px-5 h-11 inline-flex items-center gap-2 font-medium hover:bg-muted"
          >
